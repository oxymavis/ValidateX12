...
PROFILES: List[ProfilePattern] = [
    ProfilePattern(
        "blujay_210",
        "BluJay 210",
        ["EDI 210", "BLUJAY TMS INVOICE VALIDATION PROFILE", "BEGINNING SEGMENT FOR CARRIER'S INVOICE"],
        ["EDI 210 SPECS", "X12 VERSION 004010", "MOTOR CARRIER FREIGHT DETAILS AND INVOICE"],
    ),
